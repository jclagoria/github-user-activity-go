...
func withFetchServer(t *testing.T, handler http.HandlerFunc, fn func()) {
	t.Helper()
	withTestServer(t, handler, func(_ string) { fn() })
}
...
func TestFetchEvents_Success(t *testing.T) {
	...
	withFetchServer(t, func(w http.ResponseWriter, r *http.Request) {
